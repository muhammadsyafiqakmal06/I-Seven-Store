...
<head>
	...
	<title>Iseven Store | Store Air</title>
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumb-tree">
						...
						<li><a href="<?php echo base_url() ?>home/store">Macbook Air</a></li>
					</ul>
				</div>
			</div>
			<!-- /row -->
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-body">
										<h3 class="product-name"><a href="<?php echo base_url('home/detail/' . $row->kd_berkas) ?>"><?php echo $row->nama; ?></a></a></h3>
